...
public class Persoon {	 	
	...
	public static void main(String[] args) {
			...
			//We gaan instanties van de class Persoon aanmaken. Dit zijn personen met naam, achternaam en woonplaats.
			//Opdracht:maak in de class Persoon 3 instance variabelen aan van het type String: naam, achternaam en woonplaats
			//Er staat al een constructor in de class Persoon zonder parameters (boven de main methode), maak nu een extra constructor aan
		    ...
		    //Nu moet onderstaande regel succesvol kunnen runnen in de main methode:
		
//             Persoon cursist1 = new Persoon("Wouter", "van Praag", "Zaltbommel");
		
			//Maak in de class Persoon (boven de main methode) de public String methode getNaam(), deze methode returnt de instance variabele naam		
			//Maak nu in de main methode 2 nieuwe cursisten aan (cursist2 en cursist3) met zelf verzonnen naam, achternaam, woonplaats. 
			//Nu moet onderstaande regel succesvol runnen in de main methode, je vergelijkt hier met de equals() methode of de namen gelijk zijn
		
			//System.out.println(cursist2.getNaam().equals(cursist3.getNaam()));
		
			//Maak in de class Persoon (boven de main methode) de public String methode toonNAW() aan die de instance variabele naam, achternaam en woonplaats returnt (in 1 regel)
		
			//Print nu in de main methode met behulp van de methode toonNAW() de NAW gegevens van de aangemaakte Personen
			...
			//Maak nu in de class Persoon (boven de main methode) de public void methode setNaam met als methode parameter een String.
